...
#define COCOAPODS_POD_AVAILABLE_MRGLaunchImageViewController
#define COCOAPODS_VERSION_MAJOR_MRGLaunchImageViewController 0
#define COCOAPODS_VERSION_MINOR_MRGLaunchImageViewController 1
#define COCOAPODS_VERSION_PATCH_MRGLaunchImageViewController 0
